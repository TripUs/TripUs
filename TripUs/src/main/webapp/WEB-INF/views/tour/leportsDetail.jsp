            ...
            <div class="col-xs-10">
                ...
                <div class="col-md-6 col-xs-12">
                    <table class="table" id="table1">
                        ...
                        <tr>
                            <td>개장시간</td>
                            <td>${detailInfo.openperiod }</td>
                        </tr>
                        <tr>
                            <td>입장료</td>
                            <td>${detailInfo.usefeeleports }</td>
                        </tr>
						<tr>
                            <td>예약 안내</td>
                            <td>${detailInfo.reservation }</td>
                        </tr>
                        <tr>
                            <td>이용 시간</td>
                            <td>${detailInfo.usetimeleports }</td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <div class="row" id="content3">
            ...
            <div class="col-xs-10">
                <table class="table  table-bordered">
                    ...
                    <tr>
                        <td>수용 인원</td>
                        <td>${detailInfo.accomcountleports }</td>
                    </tr>
                    <tr>
                        <td>쉬는 날</td>
                        <td>${detailInfo.restdateleports }</td>
                    </tr>
                    <tr>
                        <td>유모차 대여 여부</td>
                    ...
                    <tr>
                        <td>애완 동물 가능 여부</td>
                        <td>${detailInfo.chkpetleports }</td>
                    </tr>
                    <tr>
                        <td>체험 가능 연령</td>
                        <td>${detailInfo.expagerangeleports }</td>
                    </tr>
                    <tr>
                        <td>주차 시설</td>
                        <td>${detailInfo.parkingleports }</td>
                    </tr>
                    <tr>
                        <td>주차 요금</td>
                        <td>${detailInfo.parkingfeeleports }</td>
                    </tr>
                </table>
