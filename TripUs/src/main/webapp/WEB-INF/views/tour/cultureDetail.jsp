            ...
            <div class="col-xs-10">
                ...
                <div class="col-md-6 col-xs-12">
                    <table class="table" id="table1">
                        ...
                        <tr>
                            <td>이용 요금</td>
                            <td>${detailInfo.usefee }</td>
                        </tr>
                        <tr>
                            <td>할인 정보</td>
                            <td>${detailInfo.discountinfo }</td>
                        </tr>
                        <tr>
                            <td>이용 시간</td>
                            <td>${detailInfo.usetimeculture }</td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <div class="row" id="content3">
            ...
            <div class="col-xs-10">
                <table class="table  table-bordered">
                    ...
                    <tr>
                        <td>수용 인원</td>
                        <td>${detailInfo.accomcountculture }</td>
                    </tr>
                    <tr>
                        <td>쉬는 날</td>
                        <td>${detailInfo.restdateculture }</td>
                    </tr>
                    <tr>
                        <td>유모차 대여 여부</td>
                        <td>${detailInfo.chkbabycarriageculture }</td>
                    </tr>
                    <tr>
                        <td>애완 동물 가능 여부</td>
                        <td>${detailInfo.chkpetculture }</td>
                    </tr>
                    <tr>
                        <td>주차 시설</td>
                        <td>${detailInfo.parkingculture }</td>
                    </tr>
                    <tr>
                        <td>주차 요금</td>
                        <td>${detailInfo.parkingfee }</td>
                    </tr>
                </table>
