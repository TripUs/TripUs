            ...
            <div class="col-xs-10">
                ...
                <div class="col-md-6 col-xs-12">
                    <table class="table" id="table1">
                        ...
                        <tr>
                            <td>영업 시간</td>
                            <td>${detailInfo.opentime }</td>
                        </tr>
                        <tr>
                            <td>장서는 날</td>
                            <td>${detailInfo.fairday }</td>
                        </tr>
						<tr>
                            <td>매장 안내</td>
                            <td>${detailInfo.shopguide }</td>
                        </tr>
                        <tr>
                            <td>쉬는 날</td>
                            <td>${detailInfo.restdateshopping }</td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <div class="row" id="content3">
            ...
            <div class="col-xs-10">
                <table class="table  table-bordered">
                    ...
                    <tr>
                        <td>판매 품목</td>
                        <td>${detailInfo.saleitem }</td>
                    </tr>
                    <tr>
                        <td>판매 품목별 가격</td>
                        <td>${detailInfo.saleitemcost }</td>
                    </tr>
                    <tr>
                        <td>유모차 대여 여부</td>
                        <td>${detailInfo.chkbabycarriageshopping }</td>
                    </tr>
                    <tr>
                        <td>애완 동물 가능 여부</td>
                        <td>${detailInfo.chkpetshopping }</td>
                    </tr>
                    <tr>
                        <td>규모</td>
                        <td>${detailInfo.scaleshopping }</td>
                    </tr>
                    <tr>
                        <td>주차 시설</td>
                        <td>${detailInfo.parkingshopping }</td>
                    </tr>
                </table>
