$.fn.pageMe = function(opts){
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="prev_link" title="'+settings.prevText+'"><i class="material-icons">&lt;</i></a></li>').appendTo(pager);
    }
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="next_link"  title="'+settings.nextText+'"><i class="material-icons">&gt;</i></a></li>').appendTo(pager);
    }
