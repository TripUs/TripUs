...
<body>
    ...
    <div class="row" id="content">
        ...
        <div class="col-xs-10">
            <h1 style="color:#f05562"><img style="width:80px;" src="resources/imgs/logo/App Logo.png" /><strong>회원 정보</strong></h1><br/>
            <table style="width:90%;" class="table table-striped">
                <tr>
                    <th>프로필</th>
                    <td>
                        <img width="200px" src="${sessionScope.userInfo.profile }">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#profileModal" style="vertical-align: bottom;">
                            이미지 변경
                        </button>
                    </td>
                </tr>
            ...
            <a style="backgrou" class="btn btn-default" href="myEdit/${bean.id }" role="button">수정하기</a>
                </div>
        </div>
        <div class="col-xs-1"></div>
    </div>
   ...
   <!-- footer -->
    ...
    <!--Modal Profile Img 변경-->

    <div class="modal fade" id="profileModal" tabindex="-1" role="dialog" aria-labelledby="profileModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="profileModalLabel">이미지 변경</h5>
          </div>
          <div class="modal-body">
          
          
            <form action="myUpload" method="post" enctype="multipart/form-data" data-ajax="false">
