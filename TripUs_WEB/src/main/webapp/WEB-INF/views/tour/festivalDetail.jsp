            ...
            <div class="col-xs-10">
                ...
                <div class="col-md-6 col-xs-12">
                    <table class="table" id="table1">
                        ...
                        <tr>
                            <td>행사 기간</td>
                            <td>${detailInfo.eventstartdate } ~ ${detailInfo.eventstartdate }</td>
                        </tr>
                        <tr>
                            <td>이용 요금</td>
                            <td>${detailInfo.usetimefestival }</td>
                        </tr>
						<tr>
                            <td>예매처</td>
                            <td>${detailInfo.bookingplace }</td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <div class="row" id="content3">
            ...
            <div class="col-xs-10">
                <table class="table  table-bordered">
                    ...
                    <tr>
                        <td>관람 가능 연령</td>
                        <td>${detailInfo.agelimit }</td>
                    </tr>
                    <tr>
                        <td>행사 프로그램</td>
                        <td>${detailInfo.program }</td>
                    </tr>
                    <tr>
                        <td>축제 등급</td>
                        <td>${detailInfo.festivalgrade }</td>
                    </tr>
                    <tr>
                        <td>할인 정보</td>
                        <td>${detailInfo.discountinfofestival }</td>
                    </tr>
                    <tr>
                        <td>관람 소요 시간</td>
                        <td>${detailInfo.spendtimefestival }</td>
                    </tr>
                    <tr>
                        <td>부대 행사</td>
                        <td>${detailInfo.subevent }</td>
                    </tr>
                </table>
